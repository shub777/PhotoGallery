...
public class PhotoGalleryFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mPhotoRecyclerView = (RecyclerView) v.findViewById(R.id.fragment_photo_galery_recycler_view);
    ...
    private class PhotoHolder extends RecyclerView.ViewHolder {
        ...
        public PhotoHolder(View itemView) {
            super(itemView);
            mItemImageView = (ImageView) itemView.findViewById(R.id.fragment_photo_galery_image_view);
        }
    ...
    private class PhotoAdapter extends RecyclerView.Adapter<PhotoHolder> {
        ...
        public PhotoHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = inflate.inflate(R.layout.gallery_item, parent, false);
